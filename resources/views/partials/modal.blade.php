        ...
        <div class="product__modal-inner position-relative">
            ...
            <div class="product__modal-right">
                <h3 class="product__modal-title">
                    <a href="product-details.html" class="productAJTitle">Living Room Lighting</a>
                </h3>
                ...
                <div class="product__modal-price mb-10">
                    <span class="price new-price productAJPrice">$700.00</span>
                </div>
                <div class="product__modal-des">
                    <p class="productAJDesc">Typi non habent claritatem insitam, est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod legunt saepius.…</p>
                </div>
                ...
                <div class="product__modal-categories d-sm-flex align-items-center">
                    <span class="productAJStyle">Style: </span>
                </div>
