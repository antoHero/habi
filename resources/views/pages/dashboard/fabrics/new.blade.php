                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('create.new.fabric') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" placeholder="Title of fabric" class="form-control" name="name" value="{{ old('name') }}" />
                                ...
                                <div class="col-md-6 my-2 control-label">
                                    <div class="my-2">
                                        <div class="">
                                            ...
                                            <input type="number" placeholder="Price" class="form-control" maxlength="25" name="price" id="defaultconfig" value="{{ old('price') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
