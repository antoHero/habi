                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('styles.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" placeholder="Name of style" class="form-control" name="name" id="defaultconfig" value="{{ old('name') }}" />
                                ...
                                <div class="col-md-6 my-2 control-label">
                                    <div class="my-2">
                                        <div class="">
                                            ...
                                            <input type="number" placeholder="Amount" class="form-control" maxlength="25" name="price" id="defaultconfig" value="{{ old('price') }}" />
